...
(function() {
  ...
  //= require opal/lexer
  self.$require("opal/lexer");
  //= require opal/grammar
  self.$require("opal/grammar");
  //= require opal/scope
  self.$require("opal/scope");
  return (function(__base){
...
if (idx == null) idx = nil;
      ...
      Parser_prototype.$process_call = function(sexp, level) {
        var recv = nil, meth = nil, arglist = nil, iter = nil, mid = nil, result = nil, $case = nil, path = nil, splat = nil, block = nil, tmprecv = nil, args = nil, recv_code = nil, dispatch = nil, __a, __b, __c;
        ...
        result = result['$+']((function() { if (block !== false && block !== nil) {
